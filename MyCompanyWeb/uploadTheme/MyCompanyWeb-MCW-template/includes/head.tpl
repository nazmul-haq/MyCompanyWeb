...
<link href="{$WEB_ROOT}/templates/{$template}/newassests/css/style.min.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/{$template}/newassests/css/jpopup.min.css">
<!-- Styling -->
...
<script src="{$WEB_ROOT}/templates/{$template}/newassests/js/jquery.jpopup.min.js"></script>
